<?php 
 ...
 // import phpCAS lib
 include_once ('CAS-1.3.2-1/CAS-1.3.2/CAS.php');
...
<html lang="en">
	...
	<body>
		...
		<div class="span10" id="container">
			...
			<div class="row-fluid">
				<div id="spinner" class="span12"></div>
			</div>
			<div class="row-fluid">
				<div class="span4"></div>
				<div class="span3 offset1">
					<button id="submit" class="btn btn-small" onclick="submit()">
						submit
					</button><a id="logout" href="?logout=">
